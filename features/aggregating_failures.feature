Feature: Aggregating Failures
  ...
  RSpec::Core expands this feature a bit; see [the rspec-core docs](/rspec/rspec-core/v/3-3/docs/expectation-framework-integration/aggregating-failures) for more detail.
