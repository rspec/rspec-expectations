  ...
  module Matchers
    ...
    def a_test(m, left, right)
      case m
        ...
        when "an all matcher"         ; left.should be_hash_all_matching           right
        ...
        when "an all partial matcher" ; left.should be_hash_all_partially_matching right
      end
    end

    [
      "a matcher", "an all matcher", "another matcher", "a partial matcher", "an all partial matcher" 
    ].each { |matcher_name|
    ...
    describe "actual.should =~ expected, when expected hash" do
      ...
      context "has an array of items that match a Class" do
        ...
        let(:failing         ) { { "a"=>{ "b"=>[ 3      , '4'    ] } } }
        let(:failure_message ) {
          "\e[0m{\n\e[0m  \"a\"=>{\n\e[0m    \"b\"=>[\n\e[0m      \e[31m- \e[1mFixnum\e[0m\e[32m+ \e[1m\"4\"\e[0m\n\e[0m    ]\n\e[0m  }\n\e[0m}\nWhere, \e[31m- \e[1m1 missing\e[0m, \e[32m+ \e[1m1 additional\e[0m"
        }
      ...
      context "has an array with incorrect items" do
        ...
        let(:failing         ) { { "a"=>[1,2,4] } }
        let(:failure_message ) {
          "\e[0m{\n\e[0m  \"a\"=>[\n\e[0m    \e[31m- \e[1m3\e[0m\e[32m+ \e[1m4\e[0m\n\e[0m  ]\n\e[0m}\nWhere, \e[31m- \e[1m1 missing\e[0m, \e[32m+ \e[1m1 additional\e[0m"
        }
      ...
      context "has lots of stuff" do
        ...
        let(:failure_message) {
"\e[0m{\n\e[0m  \"networks\"=>[\n\e[0m    \e[31m- \e[1m\"nbc\"\e[0m\e[32m+ \e[1m\"cnn\"\e[0m,\n\e[0m    \e[31m- \e[1m\"cnn\"\e[0m\e[32m+ \e[1m\"yyy\"\e[0m,\n\e[0m  \e[32m+ \e[1m\"zzz\"\e[0m\n\e[0m  ],\n\e[0m  \"away_team\"=>{\n\e[0m    \"short_name\"=>\e[31m- \e[1m\"SHA\"\e[0m\e[32m+ \e[1m\"unexpected2\"\e[0m\n\e[0m  },\n\e[0m\e[31m- \e[1m\"expected_key\"=>\"expected_value\"\e[0m,\n\e[0m\e[32m+ \e[1m\"unexpected_key\"=>\"unexpected_value\"\e[0m\n\e[0m}\nWhere, \e[31m- \e[1m4 missing\e[0m, \e[32m+ \e[1m5 additional\e[0m"
        }
    ...
    describe "actual.should be_hash_all_matching(expected)" do
      context "has an array of items that match a Class" do
        let(:expected        ) { { "a"=>{ "b"=>[ Fixnum , Fixnum ] } } }
        let(:actual          ) { { "a"=>{ "b"=>[ 3      , 4      ] } } }
        let(:failing         ) { { "a"=>{ "b"=>[ 3      , '4'    ] } } }
        let(:failure_message ) {
          "\e[0m{\n\e[0m  \"a\"=>{\n\e[0m    \"b\"=>[\n\e[0m      \e[34m: \e[1m3\e[0m,\n\e[0m      \e[31m- \e[1mFixnum\e[0m\e[32m+ \e[1m\"4\"\e[0m\n\e[0m    ]\n\e[0m  }\n\e[0m}\nWhere, \e[31m- \e[1m1 missing\e[0m, \e[32m+ \e[1m1 additional\e[0m, \e[34m: \e[1m1 match_class\e[0m"
        }

        it_should_behave_like "an all matcher"
      end
